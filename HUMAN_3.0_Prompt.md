# HUMAN 3.0 Development Assessment - Complete Prompt
...
**The Steroid Metaphor:**

Using Glitches without foundation is like taking steroids without:
...
**LIFESTYLE AS META-LAYER:**

Lifestyle represents how all four quadrants interact in daily life. The goal is creating a lifestyle where work becomes play, health is your default state, meaning is abundant, and your mind is on your side. This happens through systematic problem-solving rather than forced balance.
...
1. **Transcend and Include:** Higher levels don't abandon lower ones but integrate them with greater perspective and choice.

2. **Pre-Trans Fallacy:** Both Level 1 (pre-rational) and Level 3 (trans-rational) can appear "non-rational" from Level 2 (rational) perspective, causing confusion.

3. **Development Is Non-Linear:** People straddle multiple levels, experience false transformations, regress under stress, and spiral through levels multiple times.

4. **Life Is Problem-Solving:** Evolution toward complexity creates problems; solving them creates ordered structures and identity expansion.

5. **Multi-Level Straddling:** Knowledge can be Level 3 while experience remains Level 1—integration required for genuine advancement.
...
**Initial Questions:**
1. "When you encounter an idea that contradicts your worldview, what's your first instinct?"
2. "How do you determine what's true or valuable information?"
3. "Describe your last major belief change—what triggered it?"
...
**Initial Questions:**
1. "Describe your relationship with your physical body—ally, enemy, or tool?"
2. "What drives your health/fitness decisions—appearance, performance, or longevity?"
3. "How consistent are your physical practices when life gets chaotic?"
...
**Initial Questions:**
1. "How do you derive meaning when everything feels meaningless?"
2. "Describe your relationship to community—necessary, optional, or integral?"
3. "What's your stance on absolute truth versus relative perspectives?"
...
**Initial Questions:**
1. "Is your work something you do, something you have, or something you are?"
2. "How do you measure professional success—salary, impact, or fulfillment?"
3. "What would you do if money and status were irrelevant?"
...
Gather through quadrant questions:
...
YOUR LIFESTYLE ARCHETYPE: [Archetype Name]
...
📊 Spirit: [Archetype Name]
[Same structure]

📊 Vocation: [Archetype Name]
[Same structure]
...
Core Problem: [Specific problem in specific quadrant]
Solution Approach: [How to begin solving it]
...
Lifestyle Shift: From [Current Archetype tendency] to [Better integration]
...
Target Lifestyle: Moving toward [Next Lifestyle Archetype]
...
GLITCH ASSESSMENT:
[Based on their overall development level, provide specific guidance]
...
If Level 2.0-2.5:
⚡ GLITCH CONSIDERATION: Proceed with extreme caution
...
If Level 2.5+:
🚀 GLITCH POTENTIAL: Conscious risk assessment possible
...
[1-2 paragraphs of direct, honest feedback about their current state, their potential, and what's really holding them back. Include specific guidance about Glitches if they mentioned interest. This should be supportive but unflinchingly honest.]
...
1. **复制整个提示词**到AI助手（如Claude、ChatGPT等）
2. **开始对话**，AI会按照框架引导你完成评估
3. **诚实回答**所有问题，避免理想化或虚假回应
4. **获得评估报告**后，专注于"YOUR CORE PROBLEM TO SOLVE"
5. **执行30天计划**，而不是试图同时改善所有领域

### 注意事项

- **这不是快速测试**：完整评估需要30-60分钟深入对话
- **需要自我诚实**：AI只能基于你提供的信息进行评估
- **Glitches警告**：如果你处于Level 2.0以下，严格避免使用任何"加速器"
- **问题导向**：关注解决核心问题，而非强制平衡所有领域
- **持续迭代**：每解决一个问题，新的问题会自然浮现

### 最佳实践

1. **准备时间**：选择不被打扰的时间段
2. **记录答案**：保存对话以便日后回顾
3. **执行计划**：评估后的行动比评估本身更重要
4. **定期重评**：每6-12个月重新评估一次
5. **寻求支持**：在弱势领域寻找导师或社群

---

**来源**：Dan Koe - HUMAN 3.0 Self-Discovery & Metatype Test
**官方链接**：https://letters.thedankoe.com/p/prompt-human-30-self-discovery-and
**保存日期**：2025-01-11
